...
void generate_ps_logo_from_pwm(boost::numeric::ublas::matrix<double> pwm, string filename, double score_cutoff,int startPos=1, int fontsize=20, string ylabel="-log10(p)", bool info_content=false);
...
void postscript_logo_from_PKA_output(string infile, string outfile, int seqLen, double score_cutoff, int startPos=1, int fontsize=20, int cScore=5, string y_label="-log10(p)");
